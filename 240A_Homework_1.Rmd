...
2. Our data is stored in a list object after reading in by tsv.
...
1. First we're asked to compute by hand the OLS coefficients for the above regressions. We use $\hat{\beta} = (X^TX)^{-1}(X^TY)$ where $Y$ is log earnings and $X$ is education in the first regression and a matrix of education and hisp in the second.
